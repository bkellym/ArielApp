...
import 'package:ariel_app/screens/exames_consultas/widgets/detalhes_consultas/detalhe_consulta_bloc.dart';
import 'package:flutter/material.dart';

class DetalheConsulta extends StatefulWidget {
  final int widgetIndex;

  const DetalheConsulta({Key? key, required this.widgetIndex}) : super(key: key);
...
class _DetalheConsultaState extends State<DetalheConsulta> {
  final DetalheConsultaBloc _bloc = DetalheConsultaBloc();
